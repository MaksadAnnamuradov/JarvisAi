...
def GoogleSearch(term):
    ...
    oooooo = open('C:\\Users\maksa\\Documents\\projects\\JarvisAi\\Data.txt','a')
...
def Alarm(query):
    ...
    TimeHere=  open('C:\\Users\maksa\\Documents\\projects\\JarvisAi\\Data.txt','a')
...
def DownloadYouTube():
    ...
    def Download(link):
        url = YouTube(link)
        url.streams.filter(progressive=True, file_extension='mp4').order_by('resolution').desc().first().download('C:\\Users\maksa\\Documents\\projects\\JarvisAi\\YouTube\\')
        # video = url.streams.first()
        # video.download('C:\\Users\maksa\\Documents\\projects\\JarvisAi\\YouTube\\')
    ...
    os.startfile('C:\\Users\maksa\\Documents\\projects\\JarvisAi\\YouTube\\')

def SpeedTest():

    os.startfile("C:\\Users\maksa\\Documents\\projects\\JarvisAi\\DataBase\\Gui Programs\\SpeedTestGui.py")
